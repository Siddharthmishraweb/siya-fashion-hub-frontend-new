      ...
      <div className={styles.container}>
        <div className={styles.sortby_dropdown}>
          ...
          <div className={styles.options}>
            {availableFilterOptions.sortBy.map((value) => (
              <div
                key={value}
                className={`${styles.option} ${
                  sortByDescription === value ? styles.is_selected : ''
                }`}
                onClick={() => handleSortByPick(value)}
              >
                {value}
              </div>
            ))}
        ...
        <div className={styles.filter_buttons}>
          ...
          >
            ...
            <span>Filters</span>
            {conditionsCount > 0 && (
              <span className={styles.badge}>{conditionsCount}</span>
            )}
          </button>
        </div>
      </div>
